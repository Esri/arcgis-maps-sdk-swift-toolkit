...
## Instructions
 ...
 2. Open the `CustomVPSProvider` project in Xcode by double clicking on the `CustomVPSProviderExample.xcodeproj` file
 3. Specify the `ArcGISEnvironment.apiKey` in the app's main entry point
 4. Specify the VPS provider API key in `CustomVPSProviderExampleView.swift`
