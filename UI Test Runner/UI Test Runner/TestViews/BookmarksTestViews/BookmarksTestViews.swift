...
struct BookmarksTestViews: View {
***REMOVED***var body: some View {
***REMOVED******REMOVED***List {
***REMOVED******REMOVED******REMOVED***NavigationLink("Bookmarks Test Case 1", destination: BookmarksTestCase1View())
***REMOVED******REMOVED******REMOVED***NavigationLink("Bookmarks Test Case 2", destination: BookmarksTestCase2View())
