...
* **[OfflineMapAreas](https://developers.arcgis.com/swift/toolkit-api-reference/documentation/arcgistoolkit/offlinemapareas)** - Displays a list of downloadable preplanned or on-demand map areas from a given web map.
