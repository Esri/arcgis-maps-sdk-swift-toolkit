...
In keeping with best-practices, this isolates secrets from source code by generating and compiling an `AppSecrets.swift` source code file at build time using a custom build rule. To learn more about `masquerade`, consult the [documentation](https:***REMOVED***github.com/Esri/data-collection-ios/tree/main/docs#masquerade) of Esri's Data Collection app.
