...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***await ArcGISEnvironment.authenticationManager.revokeOAuthTokens()
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***await ArcGISEnvironment.authenticationManager.clearCredentialStores()
...
***REMOVED******REMOVED******REMOVED***loadables: [
***REMOVED******REMOVED******REMOVED******REMOVED***Portal.arcGISOnline(connection: .authenticated)
***REMOVED******REMOVED******REMOVED***]
***REMOVED******REMOVED***)
***REMOVED***
***REMOVED***
