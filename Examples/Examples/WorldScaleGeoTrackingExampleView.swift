...
***REMOVED******REMOVED******REMOVED******REMOVED***.onChange(of: opacity) { opacity in
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***guard let basemap = scene.basemap else { return ***REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***basemap.baseLayers.forEach { $0.opacity = opacity ***REMOVED***
