...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Image(uiImage: UIImage(named: "basemap")!)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Text(showBasemapGallery ? "Hide Basemaps" : "Show Basemaps")
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED***)
***REMOVED***
***REMOVED***
