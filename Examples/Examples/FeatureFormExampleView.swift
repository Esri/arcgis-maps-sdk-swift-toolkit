...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***.onPresentedFeatureChanged { presentedFeature in
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***print("Presented feature: \(presentedFeature?.attributes["globalid"] ?? "?")")
