...
***REMOVED***/ **Features**
***REMOVED***/
***REMOVED***/ - Displays a representation of the current `VisibleArea`/`Viewpoint` for a connected `GeoView`.
...
***REMOVED***/ in the project. To learn more about using the `OverviewMap` see the <doc:/tutorials/OverviewMapTutorial>.
