...
***REMOVED******REMOVED***guard shouldUpdateCamera(for: location) else { return ***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED***updateCameraController(location: location, heading: calibrationHeading ?? 0, altitude: currentPosition?.z ?? 0)
***REMOVED******REMOVED***
