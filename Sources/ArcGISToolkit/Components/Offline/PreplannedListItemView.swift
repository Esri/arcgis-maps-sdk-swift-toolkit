...
***REMOVED******REMOVED******REMOVED******REMOVED***PreplannedMetadataView(model: model)
***REMOVED******REMOVED***
***REMOVED***
...
***REMOVED******REMOVED***if model.allowsRemoval {
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***await model.load()
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***.disabled(!model.allowsDownload)
