...
***REMOVED***
***REMOVED***
***REMOVED******REMOVED*** TODO: move to PreplannedMapModel as static
...
***REMOVED******REMOVED***onDemandMapModels = await OnDemandMapModel.loadModels(portalItemID: portalItemID)
***REMOVED***
***REMOVED***
