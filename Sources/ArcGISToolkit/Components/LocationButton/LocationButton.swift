...
***REMOVED******REMOVED******REMOVED***Image(systemName: model.autoPanMode.imageSystemName)
...
***REMOVED***
***REMOVED***
***REMOVED******REMOVED***/ The image associated with the auto pan mode.
***REMOVED***var imageSystemName: String {
***REMOVED******REMOVED***switch self {
***REMOVED******REMOVED***case .compassNavigation:
***REMOVED******REMOVED******REMOVED***"location.north.circle"
***REMOVED******REMOVED***case .navigation:
***REMOVED******REMOVED******REMOVED***"location.north.line.fill"
***REMOVED******REMOVED***case .recenter:
***REMOVED******REMOVED******REMOVED***"location.fill"
***REMOVED******REMOVED***case .off:
