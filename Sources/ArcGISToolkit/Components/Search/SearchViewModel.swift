...
***REMOVED***@State var currentQuery: String?
***REMOVED***
...
***REMOVED***var resultMode: SearchResultMode
***REMOVED***
...
***REMOVED***@State var selectedResult: SearchResult?
***REMOVED***
...
***REMOVED***@State var sources: [SearchSourceProtocol] = []
***REMOVED***
...
***REMOVED***@State var isEligibleForRequery: Bool = false
***REMOVED***
...
***REMOVED***func accesptSuggestion(_ searchSuggestion: SearchSuggestion,
