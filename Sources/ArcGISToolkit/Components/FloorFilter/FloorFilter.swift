...
***REMOVED******REMOVED***.onChange(of: selection?.wrappedValue) {
***REMOVED******REMOVED******REMOVED***let newValue = selection?.wrappedValue
...
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***.onChange(of: viewModel.loadStatus) {
***REMOVED******REMOVED******REMOVED***if viewModel.loadStatus == .loaded,
...
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***.onChange(of: viewModel.selection) {
***REMOVED******REMOVED******REMOVED***let newValue = viewModel.selection
...
***REMOVED******REMOVED******REMOVED***if let newViewpoint = viewpoint.wrappedValue {
