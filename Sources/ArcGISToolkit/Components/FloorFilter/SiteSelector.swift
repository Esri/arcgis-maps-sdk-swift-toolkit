...
***REMOVED******REMOVED***/ - Parameter isSelectorVisible: A binding used to dismiss the site selector.
***REMOVED***public init(
***REMOVED******REMOVED***_ floorFilterViewModel: FloorFilterViewModel,
***REMOVED******REMOVED***isSelectorVisible: Binding<Bool>
***REMOVED***) {
***REMOVED******REMOVED***self.viewModel = floorFilterViewModel
***REMOVED******REMOVED***self.isSelectorVisible = isSelectorVisible
***REMOVED***
***REMOVED***
...
***REMOVED***private var isSelectorVisible: Binding<Bool>
***REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED***isSelectorVisible: isSelectorVisible
...
***REMOVED******REMOVED***private var isSelectorVisible: Binding<Bool>
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***/   - isSelectorVisible: A binding used to dismiss the site selector.
***REMOVED******REMOVED***init(
***REMOVED******REMOVED******REMOVED***_ title: String,
***REMOVED******REMOVED******REMOVED***sites: [FloorSite],
***REMOVED******REMOVED******REMOVED***isSelectorVisible: Binding<Bool>
***REMOVED******REMOVED***) {
***REMOVED******REMOVED******REMOVED***self.title = title
***REMOVED******REMOVED******REMOVED***self.sites = sites
***REMOVED******REMOVED******REMOVED***facilities = []
***REMOVED******REMOVED******REMOVED***self.isSelectorVisible = isSelectorVisible
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED***init(
***REMOVED******REMOVED******REMOVED***_ title: String,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isSelectorVisible.wrappedValue.toggle()
