...
/// portal, or an array of `BasemapGalleryItem`s. When a new basemap is selected from the
...
/// in the project. To learn more about using the `BasemapGallery` see the <doc:/tutorials/BasemapGalleryTutorial>.
