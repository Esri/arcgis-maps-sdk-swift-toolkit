...
***REMOVED***/ A circular button with a check in the center, intended to be used to clear focus on text fields.
...
***REMOVED*** label: {
***REMOVED******REMOVED******REMOVED***Image(systemName: "checkmark.circle.fill")
