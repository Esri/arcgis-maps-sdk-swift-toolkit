...
***REMOVED***public enum ARGeoViewTrackingMode {
***REMOVED******REMOVED***case ignore
***REMOVED******REMOVED***case initial
***REMOVED******REMOVED***case continuous
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***weak var delegate: ARSCNViewDelegate?
***REMOVED******REMOVED***
...
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, didAdd: node, for: anchor)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, willUpdate node: SCNNode, for anchor: ARAnchor) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, willUpdate: node, for: anchor)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, didUpdate node: SCNNode, for anchor: ARAnchor) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, didUpdate: node, for: anchor)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, didRemove node: SCNNode, for anchor: ARAnchor) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, didRemove: node, for: anchor)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED*** ARSessionObserver methods
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func session(_ session: ARSession, didFailWithError error: Error) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.session?(session, didFailWithError: error)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func session(_ session: ARSession, cameraDidChangeTrackingState camera: ARCamera) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.session?(session, cameraDidChangeTrackingState: camera)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func sessionWasInterrupted(_ session: ARSession) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.sessionWasInterrupted?(session)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func sessionInterruptionEnded(_ session: ARSession) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.sessionWasInterrupted?(session)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func sessionShouldAttemptRelocalization(_ session: ARSession) -> Bool {
***REMOVED******REMOVED******REMOVED******REMOVED***return delegate?.sessionShouldAttemptRelocalization?(session) ?? false
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func session(_ session: ARSession, didOutputAudioSampleBuffer audioSampleBuffer: CMSampleBuffer) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.session?(session, didOutputAudioSampleBuffer: audioSampleBuffer)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED*** SCNSceneRendererDelegate methods
***REMOVED***
***REMOVED******REMOVED******REMOVED***public  func renderer(_ renderer: SCNSceneRenderer, updateAtTime time: TimeInterval) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, updateAtTime: time)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, didApplyAnimationsAtTime time: TimeInterval) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, didApplyConstraintsAtTime: time)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, didSimulatePhysicsAtTime time: TimeInterval) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, didSimulatePhysicsAtTime: time)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, didApplyConstraintsAtTime time: TimeInterval) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, didApplyConstraintsAtTime: time)
***REMOVED******REMOVED***
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, willRenderScene: scene, atTime: time)
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***public func renderer(_ renderer: SCNSceneRenderer, didRenderScene scene: SCNScene, atTime time: TimeInterval) {
***REMOVED******REMOVED******REMOVED******REMOVED***delegate?.renderer?(renderer, didRenderScene: scene, atTime: time)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED******REMOVED***private var trackingMode: ARGeoViewTrackingMode = .ignore
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED***graphicsOverlays: [],
***REMOVED******REMOVED******REMOVED******REMOVED***analysisOverlays: [],
...
***REMOVED******REMOVED***func startTracking(withMode mode: ARGeoViewTrackingMode) async throws {
