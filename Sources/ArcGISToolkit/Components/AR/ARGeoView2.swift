...
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***arView.delegate = self
***REMOVED***
***REMOVED******REMOVED***
...
***REMOVED******REMOVED***private let arView = ARSCNView(frame: .zero)
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ Denotes whether tracking location and angles has started.
***REMOVED******REMOVED***private var isTracking: Bool = false
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***super.viewWillDisappear(animated)
***REMOVED******REMOVED******REMOVED***self.stopTracking()
***REMOVED***
***REMOVED******REMOVED***
