...
***REMOVED******REMOVED***context.coordinator.arSceneView = viewController.sceneView
***REMOVED***
***REMOVED***
***REMOVED***public class ARViewController: UIViewController {
...
***REMOVED******REMOVED***let arSCNView = ARSCNView(frame: .zero)
***REMOVED******REMOVED***
***REMOVED******REMOVED***var scene: ArcGIS.Scene = Scene()
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ Denotes whether tracking location and angles has started.
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public private(set) var isTracking: Bool = false
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ Denotes whether ARKit is being used to track location and angles.
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public private(set) var isUsingARKit: Bool = true
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ Whether `ARKit` is supported on this device.
***REMOVED******REMOVED***private let deviceSupportsARKit: Bool = {
***REMOVED******REMOVED******REMOVED***return ARWorldTrackingConfiguration.isSupported
***REMOVED***()
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ The world tracking information used by `ARKit`.
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public var arConfiguration: ARConfiguration = {
***REMOVED******REMOVED******REMOVED***let configuration = ARWorldTrackingConfiguration()
***REMOVED******REMOVED******REMOVED***configuration.worldAlignment = .gravityAndHeading
***REMOVED******REMOVED******REMOVED***configuration.planeDetection = [.horizontal]
***REMOVED******REMOVED******REMOVED***return configuration
***REMOVED***() {
...
***REMOVED******REMOVED******REMOVED******REMOVED***if isTracking, isUsingARKit {
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***arSCNView.session.run(arConfiguration, options: .resetTracking)
...
***REMOVED******REMOVED***private var locationTrackingMode: ARLocationTrackingMode = .ignore
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ The initial transformation used for a table top experience.  Defaults to the Identity Matrix.
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public var initialTransformation: TransformationMatrix = .identity
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public var locationDataSource: LocationDataSource? {
***REMOVED******REMOVED******REMOVED***didSet {
...
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public dynamic var translationFactor: Double {
***REMOVED******REMOVED******REMOVED***get {
***REMOVED******REMOVED******REMOVED******REMOVED***return cameraController.translationFactor
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***set {
***REMOVED******REMOVED******REMOVED******REMOVED***cameraController.translationFactor = newValue
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ Determines the clipping distance around the originCamera. The units are meters; the default is 0.0. When the value is set to 0.0 there is no enforced clipping distance.
***REMOVED******REMOVED******REMOVED***/ Setting the value to 10.0 will only render data 10 meters around the originCamera.
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public var clippingDistance: Double {
***REMOVED******REMOVED******REMOVED***get {
***REMOVED******REMOVED******REMOVED******REMOVED***return cameraController.clippingDistance ?? 0.0
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***set {
***REMOVED******REMOVED******REMOVED******REMOVED***cameraController.clippingDistance = newValue
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public dynamic var originCamera: Camera {
***REMOVED******REMOVED******REMOVED***get {
***REMOVED******REMOVED******REMOVED******REMOVED***return cameraController.originCamera
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***set {
***REMOVED******REMOVED******REMOVED******REMOVED***cameraController.originCamera = newValue
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED*** MARK: Private properties
***REMOVED******REMOVED***
...
***REMOVED******REMOVED***
***REMOVED******REMOVED***lazy var sceneView = ARSceneView(scene: scene, cameraController: cameraController)
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***if self.isUsingARKit {
***REMOVED******REMOVED******REMOVED******REMOVED***self.arSCNView.session.run(self.arConfiguration, options: .resetTracking)
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***self.isTracking = true
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ Adds subView to superView with appropriate constraints.
***REMOVED******REMOVED******REMOVED***/
***REMOVED******REMOVED******REMOVED***/ - Parameter subview: The subView to add.
***REMOVED******REMOVED***fileprivate func addSubviewWithConstraints(_ subview: UIView) {
***REMOVED******REMOVED******REMOVED******REMOVED*** Add subview to view and setup constraints.
***REMOVED******REMOVED******REMOVED***self.view.addSubview(subview)
***REMOVED******REMOVED******REMOVED***subview.translatesAutoresizingMaskIntoConstraints = false
***REMOVED******REMOVED******REMOVED***NSLayoutConstraint.activate([
***REMOVED******REMOVED******REMOVED******REMOVED***subview.leadingAnchor.constraint(equalTo: self.view.leadingAnchor),
***REMOVED******REMOVED******REMOVED******REMOVED***subview.trailingAnchor.constraint(equalTo: self.view.trailingAnchor),
***REMOVED******REMOVED******REMOVED******REMOVED***subview.topAnchor.constraint(equalTo: self.view.topAnchor),
***REMOVED******REMOVED******REMOVED******REMOVED***subview.bottomAnchor.constraint(equalTo: self.view.bottomAnchor)
***REMOVED******REMOVED******REMOVED***])
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED***public init(
***REMOVED******REMOVED******REMOVED***scene: ArcGIS.Scene = Scene(),
***REMOVED******REMOVED******REMOVED***cameraController: CameraController = TransformationMatrixCameraController(),
***REMOVED******REMOVED******REMOVED***timeExtent: Binding<TimeExtent?>? = nil,
...
***REMOVED******REMOVED******REMOVED***self.cameraController = cameraController as! TransformationMatrixCameraController
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***if !isUsingARKit || !renderVideoFeed {
...
***REMOVED******REMOVED******REMOVED******REMOVED***arSCNView.alpha = 0
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED***public override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
***REMOVED******REMOVED******REMOVED***super.init(nibName: nibNameOrNil, bundle: nibBundleOrNil)
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED***public required init?(coder: NSCoder) {
***REMOVED******REMOVED******REMOVED***super.init(coder: coder)
***REMOVED***
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED***addSubviewWithConstraints(arSCNView)
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED*** Use ARKit if device supports it.
***REMOVED******REMOVED******REMOVED***isUsingARKit = deviceSupportsARKit
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***let hostingController = UIHostingController(rootView: sceneView)
***REMOVED******REMOVED******REMOVED***addChild(hostingController)
***REMOVED******REMOVED******REMOVED***hostingController.view.frame = self.view.bounds
***REMOVED******REMOVED******REMOVED***hostingController.view.backgroundColor = .clear
***REMOVED******REMOVED******REMOVED***addSubviewWithConstraints(hostingController.view)
***REMOVED******REMOVED******REMOVED***hostingController.didMove(toParent: self)
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***Task {
***REMOVED******REMOVED******REMOVED******REMOVED***try await self.startTracking(self.locationTrackingMode)
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***Task {
***REMOVED******REMOVED******REMOVED******REMOVED***await stopTracking()
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ Starts device tracking.
***REMOVED******REMOVED******REMOVED***/
***REMOVED******REMOVED******REMOVED***/ - Parameter completion: The completion handler called when start tracking completes.  If tracking starts successfully, the `error` property will be nil; if tracking fails to start, the error will be non-nil and contain the reason for failure.
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public func startTracking(_ locationTrackingMode: ARLocationTrackingMode) async throws {
***REMOVED******REMOVED******REMOVED******REMOVED*** We have a location data source that needs to be started.
***REMOVED******REMOVED******REMOVED***self.locationTrackingMode = locationTrackingMode
***REMOVED******REMOVED******REMOVED***if locationTrackingMode != .ignore,
...
***REMOVED******REMOVED******REMOVED***/ - Since: 200.3
***REMOVED******REMOVED***public func stopTracking() async {
***REMOVED******REMOVED******REMOVED***Task {
***REMOVED******REMOVED******REMOVED******REMOVED***arSCNView.session.pause()
***REMOVED******REMOVED******REMOVED******REMOVED***await locationDataSource?.stop()
***REMOVED******REMOVED******REMOVED******REMOVED***isTracking = false
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***
***REMOVED***
...
***REMOVED******REMOVED***
***REMOVED******REMOVED***var arSceneView: ARSceneView?
***REMOVED******REMOVED***
***REMOVED******REMOVED***var cameraController: TransformationMatrixCameraController?
***REMOVED******REMOVED***
...
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***guard let arSCNView,
***REMOVED******REMOVED******REMOVED******REMOVED***  let cameraController,
***REMOVED******REMOVED******REMOVED******REMOVED***  let initialTransformation,
***REMOVED******REMOVED******REMOVED******REMOVED***  let arSceneView,
***REMOVED******REMOVED******REMOVED******REMOVED***  let sceneViewProxy = arSceneView.currentProxy() else { return ***REMOVED***
***REMOVED******REMOVED******REMOVED***
...
***REMOVED******REMOVED***get {
***REMOVED******REMOVED******REMOVED***return model.scene
***REMOVED***
***REMOVED******REMOVED***set {
***REMOVED******REMOVED******REMOVED***model.scene = newValue
***REMOVED***
***REMOVED***
***REMOVED***
***REMOVED***@ObservedObject var model: ViewModel
***REMOVED***@ObservedObject private var proxy = CustomProxy()
***REMOVED***
***REMOVED***public init(
...
***REMOVED***) {
***REMOVED******REMOVED***self.model = .init(
***REMOVED******REMOVED******REMOVED***scene: scene,
***REMOVED******REMOVED******REMOVED***cameraController: cameraController,
...
***REMOVED******REMOVED***SceneViewReader { proxy in
***REMOVED******REMOVED******REMOVED***ArcGIS.SceneView(
***REMOVED******REMOVED******REMOVED******REMOVED***scene: model.scene,
***REMOVED******REMOVED******REMOVED******REMOVED***cameraController: model.cameraController,
***REMOVED******REMOVED******REMOVED******REMOVED***timeExtent: $model.timeExtent,
***REMOVED******REMOVED******REMOVED******REMOVED***graphicsOverlays: model.graphicsOverlays,
***REMOVED******REMOVED******REMOVED******REMOVED***analysisOverlays: model.analysisOverlays
***REMOVED******REMOVED******REMOVED***)
***REMOVED******REMOVED******REMOVED***.onDrawStatusChanged(perform: { status in
***REMOVED******REMOVED******REMOVED******REMOVED***self.proxy.drawingStatus = status
***REMOVED******REMOVED***)
...
***REMOVED******REMOVED******REMOVED***.task {
***REMOVED******REMOVED******REMOVED******REMOVED***self.proxy.proxy = proxy
***REMOVED******REMOVED***.ignoresSafeArea()
***REMOVED***
***REMOVED***
***REMOVED***
***REMOVED***func currentProxy() -> SceneViewProxy? {
***REMOVED******REMOVED***return self.proxy.proxy
***REMOVED***
***REMOVED***
***REMOVED***func drawingStatus() -> ArcGIS.DrawStatus? {
***REMOVED******REMOVED***return self.proxy.drawingStatus
***REMOVED***
***REMOVED***
***REMOVED***class CustomProxy: ObservableObject {
***REMOVED******REMOVED***var proxy: SceneViewProxy?
***REMOVED******REMOVED***@Published var drawingStatus: ArcGIS.DrawStatus?
***REMOVED***
***REMOVED***
***REMOVED***class ViewModel: ObservableObject {
***REMOVED******REMOVED***@Published var scene: ArcGIS.Scene
***REMOVED******REMOVED***@Published var cameraController: CameraController
***REMOVED******REMOVED***@Published var timeExtent: TimeExtent?
***REMOVED******REMOVED***@Published var graphicsOverlays: [GraphicsOverlay]
***REMOVED******REMOVED***@Published var analysisOverlays: [AnalysisOverlay]
***REMOVED******REMOVED***
***REMOVED******REMOVED***init(
***REMOVED******REMOVED******REMOVED***scene: ArcGIS.Scene,
***REMOVED******REMOVED******REMOVED***cameraController: CameraController,
***REMOVED******REMOVED******REMOVED***timeExtent: TimeExtent? = nil,
***REMOVED******REMOVED******REMOVED***graphicsOverlays: [GraphicsOverlay],
***REMOVED******REMOVED******REMOVED***analysisOverlays: [AnalysisOverlay]
***REMOVED******REMOVED***) {
***REMOVED******REMOVED******REMOVED***self.scene = scene
***REMOVED******REMOVED******REMOVED***self.cameraController = cameraController
***REMOVED******REMOVED******REMOVED***self.timeExtent = timeExtent
***REMOVED******REMOVED******REMOVED***self.graphicsOverlays = graphicsOverlays
***REMOVED******REMOVED******REMOVED***self.analysisOverlays = analysisOverlays
***REMOVED***
***REMOVED***
***REMOVED***
