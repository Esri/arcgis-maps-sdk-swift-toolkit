...
***REMOVED******REMOVED***.onChange(of: spatialReference, initial: true) { _, new in viewModel.update(new) ***REMOVED***
***REMOVED******REMOVED***.onChange(of: unitsPerPoint, initial: true) { _, new in viewModel.update(new) ***REMOVED***
***REMOVED******REMOVED***.onChange(of: viewpoint, initial: true) { _, new in
***REMOVED******REMOVED******REMOVED***viewModel.update(new)
...
#Preview {
***REMOVED***Scalebar(
***REMOVED******REMOVED***maxWidth: 175,
***REMOVED******REMOVED***spatialReference: .webMercator,
***REMOVED******REMOVED***unitsPerPoint: 100_000,
***REMOVED******REMOVED***viewpoint: .zero
***REMOVED***)
***REMOVED***

private extension Viewpoint {
***REMOVED***static var zero: Viewpoint {
***REMOVED******REMOVED***.init(
***REMOVED******REMOVED******REMOVED***center: .init(x: .zero, y: .zero, spatialReference: .wgs84),
***REMOVED******REMOVED******REMOVED***scale: .zero,
