...
public enum ScalebarUnits {
    ...
    internal func closestDistanceWithoutGoingOver(to distance: Double, units: LinearUnit) -> Double {
...
//                let displayDistance = closestDistanceWithoutGoingOver(to: units.convert(value: distance, to: displayUnits), units: displayUnits)
                let displayDistance = closestDistanceWithoutGoingOver(to: units.convert(to: displayUnits, value: distance), units: displayUnits)
//                return displayUnits.convert(displayDistance, to: units)
                return displayUnits.convert(to: units, value: displayDistance)
            }
        }
