...
/// Displaying charts in MacCatalyst requires building your application with Xcode 14.1 or greater
/// and running on a Mac with macOS 13.0 (Ventura) or greater.  Also, Attachment previews are not
/// available when running on MacCatalyst (regardless of Xcode version).
///
/// **Features**
///
...
/// in the project. To learn more about using the `PopupView` see the <doc:/tutorials/PopupViewTutorial>.
