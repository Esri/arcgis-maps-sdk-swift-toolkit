...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Text("Done", bundle: .module)
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Text("Tap on the image for more information.", bundle: .module)
