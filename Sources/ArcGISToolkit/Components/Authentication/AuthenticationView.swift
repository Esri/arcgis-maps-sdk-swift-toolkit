...
***REMOVED***public struct AuthenticationView: View {
***REMOVED******REMOVED***public init(challenge: QueuedChallenge) {
***REMOVED******REMOVED******REMOVED***self.challenge = challenge.queuedChallenge
***REMOVED******REMOVED***
***REMOVED***
***REMOVED******REMOVED***let challenge: QueuedChallenge
***REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED***UsernamePasswordView(viewModel: TokenCredentialViewModel(challenge: challenge))
***REMOVED******REMOVED******REMOVED***case let challenge as QueuedURLChallenge:
***REMOVED******REMOVED******REMOVED******REMOVED***view(forURLChallenge: challenge)
...
***REMOVED******REMOVED***func view(forURLChallenge challenge: QueuedURLChallenge) -> some View {
...
***REMOVED******REMOVED******REMOVED******REMOVED***TrustHostView(viewModel: TrustHostChallengeViewModel(challenge: challenge))
***REMOVED******REMOVED******REMOVED***case NSURLAuthenticationMethodClientCertificate:
***REMOVED******REMOVED******REMOVED******REMOVED***CertificatePickerView(viewModel: CertificatePickerViewModel(challenge: challenge))
