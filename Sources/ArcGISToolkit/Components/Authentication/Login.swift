...
***REMOVED******REMOVED******REMOVED******REMOVED***title: String(localized: "Authentication Required", bundle: .toolkitModule),
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***with: .continueWithCredential(
