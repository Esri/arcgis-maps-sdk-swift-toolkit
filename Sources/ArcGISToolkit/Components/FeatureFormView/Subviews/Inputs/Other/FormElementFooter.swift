...
***REMOVED******REMOVED******REMOVED*** else if internalFeatureFormViewModel.focusedElement == element {
...
***REMOVED******REMOVED***&& (internalFeatureFormViewModel.previouslyFocusedElements.contains(element) || validationErrorVisibility == .visible)
***REMOVED***
***REMOVED***
...
***REMOVED******REMOVED***
***REMOVED***), internalFeatureFormViewModel.focusedElement != element {
