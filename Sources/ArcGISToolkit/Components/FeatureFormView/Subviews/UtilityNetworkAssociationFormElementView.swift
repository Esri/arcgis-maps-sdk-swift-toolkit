...
***REMOVED***
***REMOVED******REMOVED***/ <#Description#>
***REMOVED***let associationKindGroups: [FeatureFormView.AssociationKindGroup]
***REMOVED***
***REMOVED******REMOVED***/ <#Description#>
***REMOVED***let selectionAction: ((FeatureFormView.AssociationKindGroup) -> Void)
***REMOVED***
***REMOVED******REMOVED***/ <#Description#>
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***selectionAction(group)
...
***REMOVED******REMOVED***let feature: ArcGISFeature
***REMOVED******REMOVED***
...
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ <#Description#>
***REMOVED******REMOVED***public let id = UUID()
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ <#Description#>
...
***REMOVED***
***REMOVED***
***REMOVED***public struct AssociationView: View {
...
***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED***/ <#Description#>
***REMOVED******REMOVED***let selectionAction: ((ArcGISFeature) -> Void)
***REMOVED******REMOVED***
***REMOVED******REMOVED***public var body: some View {
***REMOVED******REMOVED******REMOVED***Button {
***REMOVED******REMOVED******REMOVED******REMOVED***selectionAction(association.feature)
...
***REMOVED***
***REMOVED***
***REMOVED***public struct AssociationKindGroup: Equatable, Hashable, Identifiable {
***REMOVED******REMOVED******REMOVED***/ <#Description#>
...
***REMOVED******REMOVED***let name: String
***REMOVED******REMOVED***
***REMOVED******REMOVED***public static func == (lhs: Self, rhs: Self) -> Bool {
***REMOVED******REMOVED******REMOVED***lhs.name == rhs.name
***REMOVED******REMOVED******REMOVED***&& lhs.id == rhs.id
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED***public func hash(into hasher: inout Hasher) {
***REMOVED******REMOVED******REMOVED***hasher.combine(name)
***REMOVED******REMOVED******REMOVED***hasher.combine(id)
***REMOVED***
***REMOVED***
***REMOVED***
***REMOVED***public struct AssociationKindGroupView: View {
***REMOVED******REMOVED***let associationKindGroup: AssociationKindGroup
***REMOVED******REMOVED***
***REMOVED******REMOVED***let selectionAction: ((NetworkSourceGroup) -> Void)
***REMOVED******REMOVED***
***REMOVED******REMOVED***public init(associationKindGroup: AssociationKindGroup, selectionAction: @escaping (NetworkSourceGroup) -> Void) {
***REMOVED******REMOVED******REMOVED***self.associationKindGroup = associationKindGroup
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***selectionAction(group)
...
***REMOVED***
***REMOVED***
***REMOVED***public struct NetworkSourceGroup: Equatable, Hashable, Identifiable {
***REMOVED******REMOVED******REMOVED***/ <#Description#>
...
***REMOVED***
***REMOVED***
***REMOVED***public struct NetworkSourceGroupView: View {
***REMOVED******REMOVED***let networkSourceGroup:  NetworkSourceGroup
***REMOVED******REMOVED***
***REMOVED******REMOVED***let selectionAction: (ArcGISFeature) -> Void
***REMOVED******REMOVED***
***REMOVED******REMOVED***public init(networkSourceGroup: NetworkSourceGroup, selectionAction: @escaping (ArcGISFeature) -> Void) {
***REMOVED******REMOVED******REMOVED***self.networkSourceGroup = networkSourceGroup
***REMOVED******REMOVED******REMOVED***self.selectionAction = selectionAction
***REMOVED***
***REMOVED******REMOVED***
***REMOVED******REMOVED***public var body: some View {
***REMOVED******REMOVED******REMOVED***List(networkSourceGroup.associations) {
***REMOVED******REMOVED******REMOVED******REMOVED***AssociationView(association: $0, selectionAction: selectionAction)
