...
***REMOVED******REMOVED******REMOVED******REMOVED***textField.placeholder = String(localized: "Username", bundle: .module)
...
***REMOVED******REMOVED******REMOVED***textField.placeholder = String(localized: "Password", bundle: .module)
