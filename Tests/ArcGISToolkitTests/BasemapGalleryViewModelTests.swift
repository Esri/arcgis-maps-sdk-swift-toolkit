...
***REMOVED******REMOVED***let geoModelViewModel = BasemapGalleryViewModel(geoModel)
...
***REMOVED******REMOVED***XCTAssertTrue(geoModel.basemap === geoModelViewModel.currentBasemapGalleryItem?.basemap)
...
***REMOVED******REMOVED***XCTAssertEqual(geoModel.loadStatus, .loaded)
***REMOVED******REMOVED***XCTAssertTrue(geoModel.basemap === portalViewModel.currentBasemapGalleryItem?.basemap)
...
***REMOVED***
***REMOVED***
***REMOVED******REMOVED***/ Test the `currentBasemapGalleryItem` property including valid and invalid basemaps.
...
***REMOVED******REMOVED***let viewModel = BasemapGalleryViewModel(geoModel)
***REMOVED******REMOVED***
...
***REMOVED******REMOVED***items = try await viewModel.$basemapGalleryItems.compactMap({ $0 ***REMOVED***).first
***REMOVED******REMOVED***basemapGalleryItems = try XCTUnwrap(items)
