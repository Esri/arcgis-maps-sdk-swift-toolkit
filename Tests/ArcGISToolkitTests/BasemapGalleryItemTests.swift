...
***REMOVED******REMOVED******REMOVED*** Check if `isLoading` is set to true during first call
...
***REMOVED******REMOVED***XCTAssertFalse(item.isLoading)
***REMOVED******REMOVED***
...
***REMOVED******REMOVED***isLoading = try await item.$isLoading.compactMap({ $0 ***REMOVED***).first
***REMOVED******REMOVED***loading = try XCTUnwrap(isLoading)
...
***REMOVED******REMOVED***)
***REMOVED******REMOVED***
***REMOVED******REMOVED***_ = try await otherItem.$isLoading.compactMap({ $0 ***REMOVED***).dropFirst().first
